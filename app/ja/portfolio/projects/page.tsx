...
export const metadata = buildStandardMetadata({
  title: "ポートフォリオ - プロジェクト",
  description: "ポートフォリオのプロジェクト一覧。",
  pathname: "/ja/portfolio/projects",
})
    ...
    <section className="grid grid-cols-12 gap-8 pt-[var(--header-height)]">
      ...
      <div className="col-span-12 px-4 py-8 md:col-span-9 md:pl-0 md:pr-8">
        <div className="mb-8">
          ...
          <h1 className="text-2xl md:text-3xl font-bold mb-2">プロジェクト</h1>
          <p className="text-lg text-gray-600 mb-4">
            「プロジェクト」に含まれるポートフォリオ項目。
          </p>
        ...
        {filtered.length === 0 ? (
          <JaEmptyNotice englishHref="/portfolio/projects" englishLabel="英語版のプロジェクトを見る" />
        ) : (
