...
track: "security"
featured: 2
result: "Mapped the five log types flowing through an LLM-vs-SIEM security pipeline — attack ground truth, application logs, HTTP access logs, Wazuh alerts, and Claude's classifications — the scaffolding the evaluation is built on."
status: "research"
---
