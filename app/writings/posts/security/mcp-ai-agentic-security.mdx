...
summary: "At a recent conference, I took away some key insights on how the Model Context Protocol (MCP) and AI agents are shaping the future of software engineering and the security concerns that come with them."
