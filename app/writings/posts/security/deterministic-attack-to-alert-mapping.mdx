...
track: "security"
featured: 3
result: "Replaced unreliable timestamp-proximity matching with a correlation ID threaded through the pipeline via the HTTP Referer header, turning attack-to-alert joins from a guess into a deterministic match."
status: "research"
---
