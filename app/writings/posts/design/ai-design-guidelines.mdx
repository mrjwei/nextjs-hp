...
track: "research"
featured: 4
result: "Audited Claude, ChatGPT, and Google AI Mode's onboarding against Microsoft's evidence-based Guidelines for Human-AI Interaction, surfacing where each system still owes users clarity about what it can do."
status: "research"
---
