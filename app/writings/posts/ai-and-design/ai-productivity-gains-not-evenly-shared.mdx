...
We're not quite there yet. But the direction is clear and it connects to a broader shift I've been thinking about: moving from AI as a task executor to AI as a thinking partner embedded in the design process. I wrote about a related idea in the context of product development <a href="/posts/from-requirements-to-assumptions" target="_blank">here</a>—the argument that treating our best ideas as assumptions rather than requirements is what makes rapid, AI-assisted experimentation actually work.
