...
- <a href="/posts/ai-and-design/prototyping-made-easy-how-emerging-tooling-has-transformed-the-ui-design-workflow" target="_blank">Prototyping Made Easy</a> — the LingoBun case study behind the "generation is now cheap" claim above.
- <a href="/posts/from-requirements-to-assumptions" target="_blank">From Requirements to Assumptions</a> — the case for cheap experimentation as a quality lever, referenced above.
