...
Vibe coding doesn’t remove the need for understanding. It raises the bar for how we understand. Used passively, AI helps you finish tasks; used actively, it helps you grow. That's how I'm approaching the development of [LingoBun](/writings/LingoBun), and why building with AI has made me a better learner, not a lazier one.
